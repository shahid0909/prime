                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/faculty/update/'.$faculty->id)  }}">
                                                    @csrf
                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Faculty Name</label>
                                                            <input type="Text" class="form-control" name="faculty_name" id="simpleFormEmail"
                                                                   value="{{ $faculty->name }}">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Date of Establish</label>
                                                            <div class="input-append date">
                                                                <div id="dateIcon" class="input-group datePicker">
                                                                    <input class="formDatePicker form-control" name="establish_year" type="date"
                                                                           value="{{ $faculty->establish_year }}" data-input>
                                                                    <span class="dateBtn">
