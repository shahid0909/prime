            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">All Department List</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/add_department')}}" id="addRow"
                                                               class="btn btn-info">
                                                ...
                                                <div class="table-scrollable">
                                                    <table
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="left"><img src="{{ asset($department->image) }}" style="height:40px; width:70px;" ></td>
                                                            <td>
                                                                <a href="{{ url('/department/edit/'.$department->id) }}"
                                                                   class="btn btn-primary btn-xs">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a href="{{ url('/department/delete/'.$department->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                   class="btn btn-primary btn-xs">
