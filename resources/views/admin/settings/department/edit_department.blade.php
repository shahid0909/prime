                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/department/update/'.$department->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" name="image" class="form-control" value="{{ $department->image }}">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Select Faculty</label>
                                                            <select class="form-select input-height" name="faculty_id" value="{{$department->faculty->name}}">
                                                        ...
                                                        <div class="form-group">
                                                            <img src="{{ asset($department->image) }}" style="width:400px; height:200px;" >
