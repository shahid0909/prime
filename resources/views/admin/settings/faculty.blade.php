        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">All Faculty List</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">All Faculty List</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>All Faculty List</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/add_faculty')}}" id="addRow"
                                                               class="btn btn-info">
                                                ...
                                                <div class="table-scrollable">
                                                    <table
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td class="left">{{ $i++ }}</td>
                                                            <td>{{ $faculty->name }}</td>
                                                            <td class="left">{{ $faculty->establish_year }}</td>
                                                            <td>
                                                                <a href="{{ url('/faculty/edit/'.$faculty->id) }}"
                                                                   class="btn btn-primary btn-xs">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a href="{{ url('/faculty/delete/'.$faculty->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                   class="btn btn-primary btn-xs">
