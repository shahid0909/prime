                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/image_gallery/update/'.$gallery->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        ...
                                                        @php
                                                            $emailarray =json_decode($gallery->image);
                                                        ...
                                                        <div class=' row ' style="margin-bottom: 20px;">
                                                            ...
                                                            @foreach($emailarray as $key => $email_name)
                                                                <div class='col-sm-6 col-xs-12 col-md-6 col-lg-6'>
                                                                    <a  class="close-icon btn btn-danger" href="{{ url('/admin/image_gallery/single_image/delete/'.$key.'/'.$gallery->id) }}"><i class="fa fa-trash" aria-hidden="true"></i></a>

                                                                    <a class="thumbnail fancybox" rel="ligthbox">
                                                                        <div class="form-group">
                                                                            <img src="{{ asset($email_name) }}" style="width:400px; height:200px;" >
                                                                        </div>
                                                                    </a>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row"  id="Product_email_box">
                                                                            <div class="col-md-4 product_attr_1">
                                                                                ...
                                                                                <input id="email" type="file" name="image[]" class="form-control" aria-required="true" aria-invalid="false">
                                                                                @error('image')
