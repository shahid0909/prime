            ...
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Photo Gallery List</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Photo Gallery List</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/image_gallery/add')}}" id="addRow"
                                                               class="btn btn-info">
                                                        ...
                                                        @foreach($image as $key=>$mission)
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                @elseif($mission->category == 2)
                                                                    <td>Student Activities in Pictorials</td>
                                                                @elseif($mission->category == 3)
                                                                    <td>Bangabandhu Corner</td>
                                                                @else
                                                                ...
                                                                @else
                                                                 ...
                                                                 @endif
                                                                <td>
                                                                    <a href="{{ url('/admin/image_gallery/edit/'.$mission->id) }}"
                                                                       class="btn btn-primary btn-xs">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                    <a href="{{ url('/admin/image_gallery/delete/'.$mission->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                       class="btn btn-primary btn-xs">
