        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Home Slider</div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Home Slider</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/language_school/update/'.$school->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Banner Image</label>
                                                            <input type="file" class="form-control" name="b_image" value="{{ $school->b_image }}">
                                                            @error('b_image')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <img src="{{ asset($school->b_image) }}" style="width:400px; height:200px;" >
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Image</label>
                                                            <input type="file" class="form-control" name="image" value="{{ $school->image }}">
                                                            @error('image')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <img src="{{ asset($school->image) }}" style="width:400px; height:200px;" >
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $school->status == 1)
                                                                    ...
                                                                    <option value="{{ $school->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $school->status }}">Deactivate</option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="description">{!! $school->description !!}</textarea>
                                                            @error('description')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
