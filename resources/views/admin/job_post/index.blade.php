                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/job/add')}}" id="addRow"
                                                               class="btn btn-info">
                                                    ...
                                                    <table
                                                        ...
                                                        @foreach($job as $key=>$mission)
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>{{ $mission->p_date }} To {{ $mission->d_date }}</td>
                                                                ...
                                                                @else
                                                                    ...
                                                                    @endif
                                                                <td>
                                                                    <a href="{{ url('/admin/job/edit/'.$mission->id) }}"
                                                                       class="btn btn-primary btn-xs">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                    <a href="{{ url('/admin/job/delete/'.$mission->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                       class="btn btn-primary btn-xs">
