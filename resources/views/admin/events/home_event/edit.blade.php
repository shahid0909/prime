        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Home Event</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Home Event</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/home_event/update/'.$home_events->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Title</label>
                                                            <input type="Text" class="form-control" name="title" id="simpleFormEmail"
                                                                   value="{{ $home_events->title }}">
                                                            @error('title')
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="date" class="form-control" name="date" id="simpleFormEmail" value="{{ $home_events->date }}">
                                                            @error('date')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" class="form-control" name="image" id="simpleFormEmail" value="{{ $home_events->image }}">
                                                            @error('image')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $home_events->status = 1)

                                                                    <option value="{{ $home_events->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $home_events->status }}">Deactivate</option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="description">{!! $home_events->description !!}</textarea>
                                                        </div>

                                                        <div class="form-group">
                                                            <img src="{{ asset($home_events->image) }}" style="width:400px; height:200px;" >
