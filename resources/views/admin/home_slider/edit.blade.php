                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/home_slider/update/'.$home_slider->id) }}" enctype="multipart/form-data">
                                                    @csrf

                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Title</label>
                                                            <input type="Text" class="form-control" name="s_title" id="simpleFormEmail"
                                                                   value="{{ $home_slider->s_title }}">
                                                            @error('s_title')
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" class="form-control" name="image" id="simpleFormEmail" value="{{ $home_slider->image }}">
                                                            @error('image')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $home_slider->status = 1)
                                                                    ...
                                                                    <option value="{{ $home_slider->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $home_slider->status }}">Deactivate</option>
                                                        ...
                                                        <div class="form-group">
                                                            <img src="{{ asset($home_slider->image) }}" style="width:400px; height:200px;" >
