        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Department Club Committee</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Department Club Committee</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Department Club Committee</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/club_committee/update/'.$club_committee->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="designation">
                                                                ...
                                                                @if( $club_committee->designation == 1 )
                                                                <option value="1">President</option>

                                                                @elseif( $club_committee->designation == 2 )
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="batch" id="simpleFormEmail" value="{{ $club_committee->batch }}">
                                                            @error('batch')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="club_id">
                                                                ...
                                                                <option value="{{ $club_committee->club->id }}" selected>{{ $club_committee->club->title }}</option>

                                                                @foreach($clubs as $club_in)
