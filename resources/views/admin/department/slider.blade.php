        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">All Slider List</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">All Slider List</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/add_slider')}}" id="addRow"
                                                               class="btn btn-info">
                                                    ...
                                                    <table
                                                        ...
                                                        @foreach($slider as $slider)
                                                            <tr class="odd gradeX">
                                                                <td class="left">{{ $i++ }}</td>
                                                                <td>{{ $slider->title }}</td>
                                                                <td class="left"><img src="{{ asset($slider->image) }}" style="height:40px; width:70px;" ></td>
                                                                <td>
                                                                    <a href="{{ url('/department/slider/edit/'.$slider->id) }}"
