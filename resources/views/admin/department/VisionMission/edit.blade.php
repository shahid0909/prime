        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Vision Mission</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Vision Mission</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Vision Mission</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/vision_mission/update/'.$vision_mission->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Select Department</label>
                                                            <select class="form-select input-height" name="dept_id">
                                                                <option value="{{$vision_mission->departments->id}}" selected>{{$vision_mission->departments->name}}</option>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" class="form-control" name="image" id="simpleFormEmail"
                                                                   value="{{ $vision_mission->image }}">
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Vision Description</label>
                                                            <textarea class="summernote" name="vision_description" >{!! $vision_mission->vision_description !!}</textarea>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Mission Description</label>
                                                            <textarea class="summernote" name="mission_description">{!! $vision_mission->mission_description !!}</textarea>
                                                        </div>

                                                        <div class="form-group">
                                                            <img src="{{ asset($vision_mission->image) }}" style="width:400px; height:200px;" >
