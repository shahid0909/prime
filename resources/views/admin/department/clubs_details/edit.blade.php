        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Clubs Details</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Clubs Details</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Clubs details</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/club_details/update/'.$club_details->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">

                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Vision</label>
                                                            <textarea class="summernote" name="vision">{!! $club_details->vision !!}</textarea>
                                                            @error('vision')
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="activities">{!! $club_details->activities !!}</textarea>
                                                            @error('activities')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="description">{!! $club_details->description !!}</textarea>
                                                            @error('description')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="club_id">
                                                                <option value="{{ $club_details->club_id  }}">{{ $club_details->club->title }}</option>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="faculty_member_id">
                                                                <option value="{{ $club_details->faculty_member_id  }}">{{ $club_details->faculty->m_name }}</option>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $club_details->status = 1)

                                                                    <option value="{{ $club_details->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $club_details->status }}">Deactivate</option>
