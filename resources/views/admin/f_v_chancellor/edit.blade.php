            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Edit Former Vice Chancellor</div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li class="active">Edit Former Vice Chancellor</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-box">
                                                <div class="card-head">
                                                    <header>Edit Former Vice Chancellor</header>
                                                    <div class="tools">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <form method="post" action="{{ url('/admin/f_v_Chancellor/update/'.$chancellor->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-select input-height" name="status">
                                                                    @if( $chancellor->status == 1)

                                                                        <option value="{{ $chancellor->status }}">Active</option>

                                                                    @else
                                                                        <option value="{{ $chancellor->status }}">Deactivate</option>
                                                            ...
                                                            <div class="form-group">
                                                                <img src="{{ asset($chancellor->image) }}" style="width:400px; height:200px;" >
