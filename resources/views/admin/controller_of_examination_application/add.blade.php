        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Add Controller Of Examination Application</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Add Controller Of Examination Application</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Add Controller Of Examination Application</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ route('c_o_e_a.store') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" class="form-control" name="uplode_file" id="simpleFormEmail">
                                                            @error('uplode_file')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
