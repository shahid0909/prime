        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Add Admission Requirement</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Add Admission Requirement</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Add Admission Requirement</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ route('admission_requirement.store') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Admission Session</label>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="a_requirement" ></textarea>
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">How To Apply</label>
                                                            <textarea class="summernote" name="how_to_apply"></textarea>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Admission fee</label>
                                                            <textarea class="summernote" name="admission_fee"></textarea>
                                                        </div>
