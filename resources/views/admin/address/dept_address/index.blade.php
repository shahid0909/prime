        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Department Address</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Department Address</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Department Address</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/dept_address/add')}}" id="addRow"
                                                               class="btn btn-info">
                                                ...
                                                <div class="table-scrollable">
                                                    <table
                                                        ...
                                                        @foreach($dept_address as $key=>$mission)
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                @else
                                                                    ...
                                                                    @endif
                                                                <td>
                                                                    <a href="{{ url('/admin/dept_address/edit/'.$mission->id) }}"
                                                                       class="btn btn-primary btn-xs">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                    <a href="{{ url('/admin/dept_address/delete/'.$mission->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                       class="btn btn-primary btn-xs">
