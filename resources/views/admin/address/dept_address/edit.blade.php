        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Department Address</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Department Address</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Department Address</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/dept_address/update/'.$dept_address->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="dept_id">
                                                                <option value="{{ $dept_address->departments->id }}" selected>{{ $dept_address->departments->name }}</option>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $dept_address->status = 1)

                                                                    <option value="{{ $dept_address->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $dept_address->status }}">Deactivate</option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="address">{!! $dept_address->address !!}</textarea>
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Phone Number</label>
                                                            <textarea class="summernote" name="phone_number">{!! $dept_address->phone_number !!}</textarea>
                                                        </div>

                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Email</label>
                                                            <textarea class="summernote" name="email">{!! $dept_address->email !!}</textarea>
                                                        </div>
