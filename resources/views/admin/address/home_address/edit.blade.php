        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Home Address</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Home Address</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Home Address</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/home_address/update/'.$home_address->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Status</label>
                                                            <select class="form-select input-height" name="status">
                                                                @if( $home_address->status = 1)

                                                                    <option value="{{ $home_address->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $home_address->status }}">Deactivate</option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="address">{!! $home_address->address !!}</textarea>

                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Phone Number</label>
                                                            <textarea class="summernote" name="phone_number">{!! $home_address->phone_number !!}</textarea>

                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Email</label>
                                                            <textarea class="summernote" name="email">{!! $home_address->email !!}</textarea>
