        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit CRHP</div>
                    </div>
                                        ...
                                        <div class="card card-box">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                @endif
                                                    ...
                                                    <form method="post" action="{{ url('/admin/crhp_details/update/'.$crhp_details->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="file" class="form-control" name="upload_file" value="{{ $crhp_details->upload_file }}">
                                                                @error('upload_file')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="date" class="form-control" name="date" value="{{ $crhp_details->date }}">
                                                                @error('date')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-select input-height" name="category">
                                                                    @if($crhp_details->category == 1)
                                                                        <option value="1">Research Conducted</option>
                                                                    @elseif($crhp_details->category == 2)
                                                                        <option value="2">Journal Published</option>
                                                                    @elseif($crhp_details->category == 3)
                                                                        <option value="3">Annual Report Published</option>
                                                                    @elseif($crhp_details->category == 4)
                                                                        <option value="4">Newsletter Published</option>
                                                                    @elseif($crhp_details->category == 5)
                                                                        <option value="5">Magazine Published</option>
                                                                    @else
                                                                        <option value="6">Notice Board</option>
                                                                    @endif
                                                                    <option value="1">Research Conducted</option>
                                                                    <option value="2">Journal Published</option>
                                                                    <option value="3">Annual Report Published</option>
