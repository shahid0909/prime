        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Important Date and Deadlines</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Important Date and Deadlines</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Important Date and Deadlines</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/important_date/update/'.$i_date->id) }}" enctype="multipart/form-data">
                                                    @csrf

                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Title</label>
                                                            <input type="Text" class="form-control" name="i_title" id="simpleFormEmail"
                                                                   value="{{ $i_date->i_title }}">
                                                            @error('i_title')
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="date" class="form-control" name="s_date" id="simpleFormEmail" value="{{ $i_date->s_date }}">
                                                            @error('s_date')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Image</label>
                                                            <input type="date" class="form-control" name="e_date" id="simpleFormEmail" value="{{ $i_date->e_date }}">
                                                            @error('e_date')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $i_date->status == 1)
                                                                    ...
                                                                    <option value="{{ $i_date->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $i_date->status }}">Deactivate</option>
