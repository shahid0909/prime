        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Controller Of Examination</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Controller Of Examination</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Controller Of Examination</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/c_o_e/update/'.$c_o_e->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">

                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">papers</label>
                                                            <textarea class="summernote" name="papers" >{!! $c_o_e->papers !!}</textarea>
                                                            @error('papers')
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $c_o_e->status == 1)
                                                                    ...
                                                                    <option value="{{ $c_o_e->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $c_o_e->status }}">Deactivate</option>
