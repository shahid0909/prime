            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Add Administrators</div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li class="active">Add Administrators</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-box">
                                                <div class="card-head">
                                                    <header>Add Administrators</header>
                                                    <div class="tools">
                                                    ...
                                                    <form method="post" action="{{ route('administrator.store') }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group col-md-4">
                                                                <label for="simpleFormEmail">Administrator Name</label>
