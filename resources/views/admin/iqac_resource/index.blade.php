        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">IQAC Resource List</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">IQAC Resource List</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>IQAC Resource List</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/iqac_resource/add')}}" id="addRow"
                                                               class="btn btn-info">
                                                ...
                                                <div class="table-scrollable">
                                                    <table
                                                        ...
                                                        @foreach($iqac_resource as $key=>$mission)

                                                            <tr class="odd gradeX">
                                                                <td class="left">{{ $key+1}}</td>
                                                                <td>{{ $mission->r_title }}</td>
                                                                <td align="center">
                                                                    <a
                                                                        target="_blank"
                                                                ...
                                                                @else
                                                                    ...
                                                                    @endif
                                                                <td>
                                                                    <a href="{{ url('/admin/iqac_resource/edit/'.$mission->id) }}"
                                                                       class="btn btn-primary btn-xs">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                    <a href="{{ url('/admin/iqac_resource/delete/'.$mission->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                       class="btn btn-primary btn-xs">
