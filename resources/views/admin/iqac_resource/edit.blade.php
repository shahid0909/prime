        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit IQAC Resource</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit IQAC Resource</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit IQAC Resource</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/iqac_resource/update/'.$iqac_resource->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">

                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Title</label>
                                                            <input type="Text" class="form-control" name="r_title" id="simpleFormEmail"
                                                                   value="{{ $iqac_resource->r_title }}">
                                                            @error('r_title')
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" class="form-control" name="upload_file" id="simpleFormEmail"
                                                                   value="{{ $iqac_resource->upload_file }}">
                                                            @error('upload_file')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $iqac_resource->status == 1)

                                                                    <option value="{{ $iqac_resource->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $iqac_resource->status }}">Deactivate</option>
