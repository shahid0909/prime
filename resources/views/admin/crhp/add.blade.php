        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Add CRHP</div>
                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ route('crhp.store') }}" enctype="multipart/form-data">
                                                    @csrf
