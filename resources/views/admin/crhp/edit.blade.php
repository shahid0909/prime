                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/crhp/update/'.$crhp->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">

                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">About</label>
                                                            <textarea class="summernote" name="about" >{!! $crhp->about !!}</textarea>
                                                            @error('about')
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="vision" >{!! $crhp->vision !!}</textarea>
                                                            @error('vision')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Mission</label>
                                                            <textarea class="summernote" name="mission" >{!! $crhp->mission !!}</textarea>
                                                            @error('mission')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Responsibilities</label>
                                                            <textarea class="summernote" name="responsibilities" >{!! $crhp->responsibilities !!}</textarea>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $crhp->status == 1)
                                                                    ...
                                                                    <option value="{{ $crhp->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $crhp->status }}">Deactivate</option>
