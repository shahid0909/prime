        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Search Faculty Member</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Search Faculty Member</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card card-box">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <form method="post" action="{{ route('faculty_search.store') }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-group">
                                                            <div class="form-group col-md-4">
                                                                <label for="simpleFormEmail">Select Faculty Member</label>
                                                            ...
                                                            <table
                                                                ...
                                                                @foreach($facultyInfo as $key=>$faculty)
                                                                    ...
                                                                    <tr class="odd gradeX">
                                                                        ...
                                                                        <td class="left"><img src="{{ asset($faculty->image) }}" style="height:40px; width:70px;" ></td>
                                                                        <td>{{ $faculty->m_name }}</td>
                                                                        <td>{{ $faculty->designation->designation }}</td>
                                                                        <td>
                                                                            <a href="{{ url('/admin/faculty_id_download/'.$faculty->id) }}"
