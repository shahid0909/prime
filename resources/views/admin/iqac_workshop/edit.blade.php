        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit IQAC iqac_workshop</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit IQAC iqac_workshop</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit IQAC iqac_workshop</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/iqac_workshop/update/'.$iqac_workshop->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">

                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Title</label>
                                                            <input type="Text" class="form-control" name="w_title" id="simpleFormEmail"
                                                                   value="{{ $iqac_workshop->w_title }}">
                                                            @error('w_title')
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="dept_id">
                                                                <option value="{{ $iqac_workshop->departments->id }}" selected>{{ $iqac_workshop->departments->name }}</option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="w_details">{!! $iqac_workshop->w_details !!}</textarea>
                                                            @error('w_details')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $iqac_workshop->status == 1)

                                                                    <option value="{{ $iqac_workshop->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $iqac_workshop->status }}">Deactivate</option>
