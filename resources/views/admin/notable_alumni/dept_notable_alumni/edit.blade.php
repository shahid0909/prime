        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Department Notable Alumni</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Department Notable Alumni</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Department Notable Alumni</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/dept_notable/update/'.$dept_notable->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="designation" id="simpleFormEmail"  value="{{ $dept_notable->designation }}">
                                                            @error('designation')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" class="form-control" name="image" id="simpleFormEmail" value="{{ $dept_notable->image }}">
                                                            @error('image')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="dept_id">
                                                                <option value="{{ $dept_notable->departments->id }}" selected>{{ $dept_notable->departments->name }}</option>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $dept_notable->status = 1)

                                                                    <option value="{{ $dept_notable->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $dept_notable->status }}">Deactivate</option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="description">{!! $dept_notable->description !!}</textarea>
                                                        </div>


                                                        <div class="form-group">
                                                            <img src="{{ asset($dept_notable->image) }}" style="width:400px; height:200px;" >
