        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Department Notice List</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Department Notice List</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Department Notice List</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/add_dept_notice')}}" id="addRow"
                                                               class="btn btn-info">
                                                ...
                                                <div class="table-scrollable">
                                                    <table
                                                        ...
                                                        @foreach($dept_notice as $key=>$mission)
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('/dept_notice/edit/'.$mission->id) }}"
                                                                       class="btn btn-primary btn-xs">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                    <a href="{{ url('/dept_notice/delete/'.$mission->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                       class="btn btn-primary btn-xs">
