                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <option selected="" value="">Select Any</option>
                                                @foreach ($studentlistt as $item)
                                                <option value="{{ $item->id }}">{{ $item->batche }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="card-body ">
                                            <div class="admit-card">
                                                <div class="BoxA">
                                                    <div class="row">
                                                    <div class="col-sm-2">
                                                        <img class="admit_image" src="{{ asset('admin_assets/img/admit/Prime_University.png') }}" />
                                                    </div>
                                                    <div class="col-sm-8 txt-center">
                                                        <h5 class="uni_title">PRIME UNIVERSITY</h5>
                                                        <p>114/116 Mazar Road, Mirpur-1, Dhaka 1216</p>
                                                        <p>Phone: 0000000000, Mobile:01999999999</p>
                                                    </div>
                                                    <div class="col-sm-2">
                                                        <table class="table">
                                                        <tbody>
                                                            <tr>
                                                            <th scope="row txt-center"  style="border:none">
                                                                <img class="admit_image" src="{{ asset($item->std_image) }}" />
                                                            </th>
                                                            </tr>
                                                        </tbody>
                                                        </table>
                                                ...
                                                <div class="BoxC">
                                                    ...
                                                    <div class="col-sm-12 txt-center">
                                                        <h3 class="admit_h3">Admit Card</h3>
                                                        <h3 class="admit_h3">{{ $examlist->exam_name }}, {{ $examlist->exam_session }}</h3>
                                                    </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <table class="table table-bordered">
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <b>Student Name: </b>{{ $item->student_name }}
                                                                        </td>
                                                                        <td>
                                                                            <b>ID: </b> {{ $item->student_id }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    <td><b>Batch: </b>{{ $item->batche }}</td>
                                                                    <td><b>Program: </b>{{ $item->program }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                    <td><b>Date of Examination</td>
                                                                    <td><b>{{ $examlist->date_of_exam }}</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
