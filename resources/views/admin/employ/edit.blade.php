            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Edit Employ Details</div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-box">
                                                <div class="card-head">
                                                    <header>Edit Employ Details</header>
                                                    <div class="tools">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <form method="post" action="{{ url('/admin/employ/update/'.$employ->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="file" class="form-control" name="image" value="{{ $employ->image }}">
                                                                @error('image')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            ...
                                                            @php
                                                                $emailarray =json_decode($employ->email);

                                                                $phonearray =json_decode($employ->number);
                                                            @endphp
                                                            ...
                                                            <div class=' row ' style="margin-bottom: 20px;">
                                                                ...
                                                                @foreach($emailarray as $key => $email_name)
                                                                    <div class='col-sm-6 col-xs-12 col-md-6 col-lg-6'>
                                                                        ...
                                                                        <a  class="close-icon btn btn-danger" href="{{ url('/admin/employ_member_email',$key.'/'.$employ->id) }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                            ...
                                                            <div class=' row ' style="margin-bottom: 20px;">
                                                                ...
                                                                @foreach($phonearray as $key => $phone_name)
                                                                    <div class='col-sm-6 col-xs-12 col-md-6 col-lg-6'>
                                                                        ...
                                                                        <a  class="close-icon btn btn-danger" href="{{ url('/admin/employ_member_phone',$key.'/'.$employ->id) }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-select input-height" name="e_designation">
                                                                    <option value="{{ $employ->desig->id }}">{{ $employ->desig->designation }}</option>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-select input-height" name="administrators_id">
                                                                    <option value="{{ $employ->admin->id }}">{{ $employ->admin->o_name }}</option>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-select input-height" name="status">
                                                                    @if( $employ->status = 1)
                                                                        ...
                                                                        <option value="{{ $employ->status }}">Active</option>

                                                                    @else
                                                                        <option value="{{ $employ->status }}">Deactivate</option>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-select input-height" name="parity">
                                                                    <option value="{{ $employ->parity }}">{{ $employ->parity }}</option>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <textarea class="summernote" name="about">{!! $employ->about !!}</textarea>
                                                                @error('about')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <img src="{{ asset($employ->image) }}" style="width:400px; height:200px;" >
