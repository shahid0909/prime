        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit IQAC Details</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit IQAC Details</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit IQAC Details</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                @endif
                                                    ...
                                                    <form method="post" action="{{ url('/admin/iqac_details/update/'.$iqac_details->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="file" class="form-control" name="upload_file" value="{{ $iqac_details->file }}">
                                                                @error('upload_file')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="date" class="form-control" name="date" value="{{ $iqac_details->date }}">
                                                                @error('date')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                                @enderror
                                                            </div>
