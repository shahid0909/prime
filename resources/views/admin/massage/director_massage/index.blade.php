        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Director Massage</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Director Massage</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Director Massage</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/massage_director/add')}}" id="addRow"
                                                               class="btn btn-info">
                                                ...
                                                <div class="table-scrollable">
                                                    <table
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th> Short Massage </th>
                                                            <th> Long Massage </th>
                                                            <th> Language School Facilities </th>
                                                            <th> Status </th>
                                                            <th> Action </th>
                                                        </tr>
                                                        </thead>
                                                        ...
                                                        @foreach($director_massage as $key=>$mission)

                                                            <tr class="odd gradeX">
                                                                <td class="left">{{ $key+1}}</td>
                                                                <td>{{ $mission->e_name }}</td>
                                                                <td>{{ $mission->short_massage }}</td>
                                                                <td>{!! $mission->long_massage !!} </td>
                                                                <td>{!! $mission->s_facilities !!} </td>
                                                                ...
                                                                @endif
                                                                <td>
                                                                    <a href="{{ url('/admin/massage_director/edit/'.$mission->id) }}"
                                                                       class="btn btn-primary btn-xs">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                    <a href="{{ url('/admin/massage_director/delete/'.$mission->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                       class="btn btn-primary btn-xs">
