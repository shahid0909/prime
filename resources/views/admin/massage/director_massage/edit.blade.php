        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Director Massage</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Director Massage</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Director Massage</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/massage_director/update/'.$massage_vc->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">

                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Employ</label>
                                                            <select class="form-select input-height" name="e_id">

                                                                <option value="{{ $massage_vc->e_name->id }}">{{ $massage_vc->e_name->e_name }}</option>

                                                                @foreach($employ as $employs)
                                                                    <option value="{{ $employs->id }}">{{ $employs->e_name }}</option>
                                                                @endforeach
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <label for="simpleFormEmail">Language School Facilities</label>
                                                            <textarea class="summernote" name="s_facilities">{!! $massage_vc->s_facilities !!}</textarea>
                                                            @error('s_facilities')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
