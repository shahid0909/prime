        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Dean Massage</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Dean Massage</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="{{url('/admin/massage_dean/add')}}" id="addRow"
                                                               class="btn btn-info">
                                                ...
                                                <div class="table-scrollable">
                                                    <table
                                                        ...
                                                        @foreach($dean_massage as $key=>$mission)
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td>
                                                                    <a href="{{ url('/admin/massage_dean/edit/'.$mission->id) }}"
                                                                       class="btn btn-primary btn-xs">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                    <a href="{{ url('/admin/massage_dean/delete/'.$mission->id) }}" onclick="return confirm('Are you sure to delete')"
                                                                       class="btn btn-primary btn-xs">
