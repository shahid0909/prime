        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Dean Massage</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Dean Massage</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Dean Massage</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/massage_dean/update/'.$massage_vc->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">

                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Faculty</label>
                                                            <select class="form-select input-height" name="faculty_id">

                                                                <option value="{{ $massage_vc->faculty->id }}">{{ $massage_vc->faculty->name }}</option>

                                                                @foreach($faculty as $employs)
                                                                    <option value="{{ $employs->id }}">{{ $employs->name }}</option>
                                                                @endforeach
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="e_id">

                                                                <option value="{{ $massage_vc->e_name->id }}">{{ $massage_vc->e_name->m_name }}</option>

                                                                @foreach($employ as $employs)
                                                                    <option value="{{ $employs->id }}">{{ $employs->m_name }}</option>
                                                                @endforeach
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="short_massage" value="{{ $massage_vc->short_massage }}">
                                                            @error('short_massage')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $employs->status == 1)
                                                                    ...
                                                                    <option value="{{ $employs->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $employs->status }}">Deactivate</option>
