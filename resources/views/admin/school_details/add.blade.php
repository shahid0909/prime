        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Add School Details</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Add School Details</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Add School Details</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ route('school_details.store') }}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="Text" class="form-control" name="title" placeholder="Time Place">
                                                            @error('title')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="duration_class" placeholder="Duration of class">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="time" placeholder="Time Range">
                                                            @error('time')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="weekly_class" placeholder="Weekly Class">
                                                            @error('weekly_class')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="course_status" placeholder="Course Status">
                                                            @error('course_status')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" name="course_fee" placeholder="Course Fee">
                                                            @error('course_fee')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
