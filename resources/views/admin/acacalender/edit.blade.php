            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Edit Academic Calender</div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li class="active">Edit Academic Calender</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card card-box">
                                                <div class="card-head">
                                                    <header>Edit Academic Calender</header>
                                                    <div class="tools">
                                                ...
                                                <div class="card-body ">
                                                    ...
                                                    <form method="post" action="{{ url('/admin/aca_calender/update/'.$class_exam->id) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-select input-height" name="session_id">
                                                                    <option value="{{ $class_exam->start_session->id }}" selected>{{ $class_exam->start_session->startsession }}</option>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                <label for="simpleFormEmail">Upload File</label>
                                                                <input type="file" class="form-control" name="upload_file" id="simpleFormEmail"
                                                                       value="{{ $class_exam->upload_file }}">
                                                                @error('upload_file')
                                                                <span class="text-danger"> {{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <select class="form-select input-height" name="status">
                                                                    @if( $class_exam->status == 1)
                                                                        ...
                                                                        <option value="{{ $class_exam->status }}">Active</option>

                                                                    @else
                                                                        <option value="{{ $class_exam->status }}">Deactivate</option>
