        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Admission Promotion</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Admission Promotion</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Admission Promotion</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/admission_promotion/update/'.$admission_promotion->id) }}" enctype="multipart/form-data">
                                                    @csrf

                                                    <div class="form-group">
                                                        <div class="form-group col-md-4">
                                                            <label for="simpleFormEmail">Title</label>
                                                            <input type="Text" class="form-control" name="a_title" id="simpleFormEmail"
                                                                   value="{{ $admission_promotion->a_title }}">
                                                            @error('a_title')
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" class="form-control" name="image" id="simpleFormEmail" value="{{ $admission_promotion->image }}">
                                                            @error('image')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $admission_promotion->status == 1)

                                                                    <option value="{{ $admission_promotion->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $admission_promotion->status }}">Deactivate</option>
                                                        ...
                                                        <div class="form-group">
                                                            <img src="{{ asset($admission_promotion->image) }}" style="width:400px; height:200px;" >
