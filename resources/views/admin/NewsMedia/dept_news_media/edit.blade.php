        ...
        <div class="page-content">
            <div class="page-bar">
                <div class="page-title-breadcrumb">
                    <div class=" pull-left">
                        <div class="page-title">Edit Department News & Media</div>
                    </div>
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">Edit Department News & Media</li>
                    </ol>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card card-box">
                                            <div class="card-head">
                                                <header>Edit Department News & Media</header>
                                                <div class="tools">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <form method="post" action="{{ url('/admin/dept_news/update/'.$dept_news->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="date" class="form-control" name="date" id="simpleFormEmail"  value="{{ $dept_news->date }}">
                                                            @error('date')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="file" class="form-control" name="image" id="simpleFormEmail" value="{{ $dept_news->image }}">
                                                            @error('image')
                                                            <span class="text-danger"> {{ $message }}</span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="dept_id">
                                                                <option value="{{ $dept_news->departments->id }}" selected>{{ $dept_news->departments->name }}</option>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-select input-height" name="status">
                                                                @if( $dept_news->status = 1)

                                                                    <option value="{{ $dept_news->status }}">Active</option>

                                                                @else
                                                                    <option value="{{ $dept_news->status }}">Deactivate</option>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea class="summernote" name="description">{!! $dept_news->description !!}</textarea>
                                                        </div>


                                                        <div class="form-group">
                                                            <img src="{{ asset($dept_news->image) }}" style="width:400px; height:200px;" >
