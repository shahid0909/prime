                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pr-50 md-pr-15">
                        <div class="blog-deatails">
                            ...
                            <div class="blog-full">
                                <form method="post" action="{{ route('student_apply.store_3') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">permanent Country</label>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"> permanent District Name</label>
                                    ...
                                    <div class="form-group">
                                        <label >permanent Thana Name</label>
