                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">{{ \Carbon\Carbon::parse($postgraduate->a_l_date)->isoFormat('MMMM')}} {{ \Carbon\Carbon::parse($postgraduate->a_l_date)->isoFormat('D')}}, {{ \Carbon\Carbon::parse($postgraduate->a_l_date)->isoFormat('YYYY')}}</td>

                                        </tr>
                                        <tr>
                                            <td>Admission Test Date</td>
                                            <td align="center">{{ \Carbon\Carbon::parse($postgraduate->a_t_date)->isoFormat('MMMM')}} {{ \Carbon\Carbon::parse($postgraduate->a_t_date)->isoFormat('D')}}, {{ \Carbon\Carbon::parse($postgraduate->a_t_date)->isoFormat('YYYY')}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                                            ...
                                                            <div class="faq-content">
                                                                <div id="accordion" class="accordion">
                                                                    <div class="card" style="border-radius: 15px; margin-bottom: 20px; box-shadow: 0px 0px 10px 0px #cccccc;">
                                                                        ...
                                                                        >
                                                                            <div class="card-body">
                                                                                <p>{!! $postgraduate->a_requirement !!}</p>
                                                                    ...
                                                                    <div class="card" style="margin-bottom: 20px; border-radius: 10px; box-shadow: 0px 0px 10px 0px;">
                                                                        ...
                                                                        >
                                                                            <div class="card-body">
                                                                                <p>{!! $postgraduate->admission_fee !!}</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
